...
def main():
    ...
    if args.enable_ai and not (
        os.getenv("OPENAI_MODEL")
        and (os.getenv("KNOWLEDGE_OPENAI_BASE_URL") or os.getenv("OPENAI_BASE_URL"))
        and os.getenv("OPENAI_API_KEY")
    ):
        parser.error(
            "AI requires OPENAI_MODEL, KNOWLEDGE_OPENAI_BASE_URL (or OPENAI_BASE_URL), "
            "and OPENAI_API_KEY"
        )
